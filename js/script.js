...
function createWeatherDay(data, index, placeInsert) {
    ...
    const myIconPath = 'https://github.com/EiNzp/My_Weather-2/tree/main/imgs/weather/64x64' + iconName;
    ...
    for (let i = 2; i < weatherTableRows.length; i++) {
        ...
        for (let j = 0; j < tdCollection.length; j++) {
            ...
            if (td.tagName !== 'TD') {
                ...
                const myIconPath = 'https://github.com/EiNzp/My_Weather-2/tree/main/imgs/weather/64x64' + timesOfDay + iconName;
